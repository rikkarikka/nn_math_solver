...
def makeVocabulary(filename, size, SRC=True):
...
def initVocabulary(name, dataFile, vocabFile, vocabSize,SRC=False):
    ...
    if vocab is None:
        ...
        genWordVocab, genFeaturesVocabs = makeVocabulary(dataFile, vocabSize,SRC)
        vocab = genWordVocab
