...
import mydatasets
from rik104evalTest import eval,test
from torchtext.vocab import GloVe
from rik104vecHandler import Vecs
...
def train(args):
    ...
    for epoch in range(args.epochs):
        ...
        (avg_loss, accuracy, corrects, size, t5_acc, t5_corrects, mrr) = eval(val_iter, model,vecs,TEXT)#, args.device)
