...
def main():
    ...
    train, val, test = data.TabularDataset.splits(
        path='../tencent/data/', train='train_0.6.tsv',
        validation='train_dev_0.6_common.tsv', test='train_dev_0.6_uncommon.tsv', format='tsv',
    ...
    model = torch.load('../tencent/models/common_0.6/net-lstm_e25_bs8_opt-adam_ly1_hs300_dr2_ed200_fembFalse_ptembFalse_drp0.3/acc49.00_e6.pt')
