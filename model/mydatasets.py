...
class MWP(data.Dataset):
    ...
    @classmethod
    def splits(cls, text_field, label_field, train_src, train_tgt, val_src, val_tgt, test_src, test_tgt):
        ...
        train_data = cls(data_src=train_src, data_tgt=train_tgt, text_field=text_field, label_field=label_field)
        print('Getting validation split...')
        val_data = cls(data_src=val_src, data_tgt=val_tgt, text_field=text_field, label_field=label_field)
        print('Getting test split...')
        test_data = cls(data_src=test_src, data_tgt=val_tgt, text_field=text_field, label_field=label_field)
